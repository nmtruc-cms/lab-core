...
class Auth extends ShieldAuth
{
     ...
     */
    public array $views = [
        'login'                       => '\Modules\Core\Views\Auth\login',
        'register'                    => '\Modules\Core\Views\Auth\register',
        'layout'                      => '\Modules\Core\Views\Auth\layout',
    ...
    public function loginRedirect(): string
    {
        ...
        if ($session->getTempdata('magicLogin')) {
            return $this->getUrl(site_url('set-password'));
        }

        $url = $session->getTempdata('beforeLoginUrl') ?? lab_core_home_url();
