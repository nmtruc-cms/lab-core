...
class CreateImsFormulationAttachmentsTable extends Migration
{
    public function up(): void
    {
        ...
        $this->forge->createTable('ims_formulation_attachments', true);
    }

    public function down(): void
    {
        $this->forge->dropTable('ims_formulation_attachments', true);
    }
}
